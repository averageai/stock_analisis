  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <nav className="backdrop-blur-md bg-gray-900/80 border-b border-gray-700/50 sticky top-0 z-50">
            ...
            <div className="flex items-center">
              <div className="flex items-center space-x-4">
                ...
                <div className="relative">
                  <div className="w-10 h-10 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 rounded-xl flex items-center justify-center shadow-lg transform hover:scale-105 transition-all duration-300">
        ...
        <div className="lg:hidden">
          <div className="px-4 py-3 space-y-2 bg-gray-800/50 backdrop-blur-md border-t border-gray-700/50">
            <Link href="/" className={`mobile-nav-link-modern ${isActive('/') ? 'mobile-nav-link-active' : ''}`}>
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
              </svg>
              <span>Dashboard</span>
            </Link>
            <Link href="/proyeccion-compras" className={`mobile-nav-link-modern ${isActive('/proyeccion-compras') ? 'mobile-nav-link-active' : ''}`}>
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <span>Proyección</span>
            </Link>
            <Link href="/recompra-proveedor" className={`mobile-nav-link-modern ${isActive('/recompra-proveedor') ? 'mobile-nav-link-active' : ''}`}>
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                <path d="M4 3a2 2 0 100 4h12a2 2 0 100-4H4z" />
                <path fillRule="evenodd" d="M3 8h14v7a2 2 0 01-2 2H5a2 2 0 01-2-2V8zm5 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z" clipRule="evenodd" />
              </svg>
            ...
            <Link href="/productos-sin-movimiento" className={`mobile-nav-link-modern ${isActive('/productos-sin-movimiento') ? 'mobile-nav-link-active' : ''}`}>
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
              </svg>
              <span>Sin Movimiento</span>
            </Link>
            <Link href="/mas-vendidos" className={`mobile-nav-link-modern ${isActive('/mas-vendidos') ? 'mobile-nav-link-active' : ''}`}>
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z" />
                <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z" />
              </svg>
            ...
            <Link href="/debug-db" className={`mobile-nav-link-modern ${isActive('/debug-db') ? 'mobile-nav-link-active' : ''}`}>
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
              </svg>
              <span>Debug</span>
      ...
      <style jsx>{`
        .nav-link-modern {
          @apply flex items-center space-x-2 px-4 py-2 rounded-lg text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-800/50 transition-all duration-200 relative overflow-hidden;
        }
